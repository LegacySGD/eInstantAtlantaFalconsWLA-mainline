...
public class AtlantaFalconsWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(AtlantaFalconsWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/AtlantaFalconsWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/AtlantaFalconsWLAIW/InitOutcome.xml").getDocumentElement();
